<template>
    <div class="date-container">
        <input type="text" readonly @focus="showCalendar" v-model="outputDate" :placeholder="placeholder"
               v-bind="$attrs" :id="id+'-output'" :class="inputClass"/>
        <input type="hidden" @change="inputChangeDesktop" v-validate="vValidate" v-model="modelValue" :name="name"
               :id="id" :data-vv-as="dataVvAs"/>

        <div class="date-select" v-show="calendarOpen">
            <div class="popup" onwheel="event.preventDefault()">
                <span class="tip"></span>
                <div class="select day" @wheel="dayWheel" @touchstart="fingerStart"
                ...
                <div class="select month" @wheel="monthWheel" @touchstart="fingerStart"
                ...
                <div class="select year" @wheel="yearWheel" @touchstart="fingerStart"
